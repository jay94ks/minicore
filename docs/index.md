...
| [DC-0CC88ABB](./DC-0CC88ABB.md) | HPET 없는 환경에서 스케줄러 LAPIC 턱과 Timer 전역 턱의 하드웨어 소유권 충돌 | approved |
...
| [DC-79A2387A](./DC-79A2387A.md) | 커널 C++ 런타임/코딩 컴벤션 세부 미정 | approved |
...
| [DC-B80D8D31](./DC-B80D8D31.md) | 스케줄러: 스케줄링 정책/타이머 턱/로드밸런싱 세부 미정 | approved |
...
| [RM-23F4B687](./RM-23F4B687.md) | Minicore 작업 지침 — 코딩 컴벤션 및 문서화 원칙 | review |
...
| [SP-C2670F69](./SP-C2670F69.md) | AHCI(SATA 스토리지 컴트롬러) 드라이버 — 설계 제안 | review |
